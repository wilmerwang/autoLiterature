...
def autoliter(root_path, output, dropbox_access_token, interval_time):
    os.system("python {}/scr/autoliterature.py --root_path {} --output {} --dropbox_access_token {} --interval_time {}".format(FILE_PATH, 
                                                                                                                            root_path,
                                                                                                                            output,
...
def autoimg(root_path, dropbox_access_token, interval_time):
    os.system("python {}/scr/autoimage.py --root_path {} --dropbox_access_token {} --interval_time {}".format(FILE_PATH,
                                                                                                           root_path,
                                                                                                           dropbox_access_token,
                                                                                                           interval_time))
...
def main():
    ...
    with Executor(max_workers=2) as executor: 
        task1 = executor.submit(autoliter, root_path, output, dropbox_access_token, interval_time)
